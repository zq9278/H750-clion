...
uint8_t x_point;
uint8_t y_point;
uint8_t x_point_temp;
uint8_t y_point_temp;
...
void FT5206_INT_SoftI2C(void ) {
    ...
    FT5206_RD_Reg_SoftI2C(0x03, &x_point_temp, 1);
    FT5206_RD_Reg_SoftI2C(0x04, &x_point, 1);
    FT5206_RD_Reg_SoftI2C(0x05, &y_point_temp, 1);
    FT5206_RD_Reg_SoftI2C(0x06, &y_point, 1);

    tpDev.x =((x_point_temp << 8)|x_point)&0xfff;
    tpDev.y =((y_point_temp << 8)|y_point)&0xfff;
}
