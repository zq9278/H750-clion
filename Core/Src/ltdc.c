...
void MX_LTDC_Init(void)
{
  ...
  hltdc.Init.AccumulatedActiveH = 653;
  hltdc.Init.TotalWidth = 501;
  hltdc.Init.TotalHeigh = 661;
...
void HAL_LTDC_MspInit(LTDC_HandleTypeDef* ltdcHandle)
{
  ...
  */
    ...
    */
    ...
    GPIO_InitStruct.Pin = GPIO_PIN_15|GPIO_PIN_9|GPIO_PIN_6|GPIO_PIN_5
...
void HAL_LTDC_MspDeInit(LTDC_HandleTypeDef* ltdcHandle)
{
  ...
  /* USER CODE END LTDC_MspDeInit 0 */
    ...
    */
    ...
    HAL_GPIO_DeInit(GPIOJ, GPIO_PIN_15|GPIO_PIN_9|GPIO_PIN_6|GPIO_PIN_5
                          |GPIO_PIN_2|GPIO_PIN_3|GPIO_PIN_4);
